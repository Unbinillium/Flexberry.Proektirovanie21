...
moduleForModel('i-i-s-proektirovanie2-запас-материалов', 'Unit | Serializer | i-i-s-proektirovanie2-запас-материалов', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-proektirovanie2-запас-материалов',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
